...
extern "C" {
#endif
void  rmaPropagate0_p_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_dut_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate0_r_dut_simv_daidir (UB  * pcode);
void  rmaPropagate0_t0_dut_simv_daidir (UB  * pcode, UB  val);
void  rmaPropagate0_wn_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_dut_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate1_r_dut_simv_daidir (UB  * pcode);
void  rmaPropagate1_wn_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_p_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_f_dut_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate2_r_dut_simv_daidir (UB  * pcode);
void  rmaPropagate2_wn_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_p_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_f_dut_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate3_r_dut_simv_daidir (UB  * pcode);
void  rmaPropagate3_wn_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_p_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_f_dut_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate4_r_dut_simv_daidir (UB  * pcode);
void  rmaPropagate4_wn_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_p_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_f_dut_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate6_r_dut_simv_daidir (UB  * pcode);
void  rmaPropagate6_wn_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_p_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_f_dut_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate7_r_dut_simv_daidir (UB  * pcode);
void  rmaPropagate7_wn_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_p_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_f_dut_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate8_r_dut_simv_daidir (UB  * pcode);
void  rmaPropagate8_wn_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_p_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_f_dut_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate9_r_dut_simv_daidir (UB  * pcode);
void  rmaPropagate9_wn_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_p_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_f_dut_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate10_r_dut_simv_daidir (UB  * pcode);
void  rmaPropagate10_wn_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_p_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_dut_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_f_dut_simv_daidir (UB  * pcode, scalar  val, U  I615, scalar  * I1485, U  did);
void  rmaPropagate15_r_dut_simv_daidir (UB  * pcode);
void  rmaPropagate15_wn_dut_simv_daidir (UB  * pcode, scalar  val);
