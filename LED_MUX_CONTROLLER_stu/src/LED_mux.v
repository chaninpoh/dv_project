...
module LED_mux
	#(parameter N=3) //last 3 bits will be used as output. Frequency=50MHz/(2^(N-3)). So N=19 will have 763Hz
	(
	input clk,rst,
	 ...
	 */
	 ...
	 always @* begin
		 seg_out=0;
			 case(hex_out[4:0])
			 5'd0: seg_out[6:0]=7'b0000_001; //'h81
			 5'd1: seg_out[6:0]=7'b1110_011; // F3
			 5'd2: seg_out[6:0]=7'b1001_010; // C8//BUG1-ERROR INJECTION
			 5'd3: seg_out[6:0]=7'b1100_000; //   E0
			 5'd4: seg_out[6:0]=7'b0110_010; //B2
			 5'd5: seg_out[6:0]=7'b0100_100; //A4
			 5'd6: seg_out[6:0]=7'b0001_110; //86 //BUG2-ERROR INJECTION
			 5'd7: seg_out[6:0]=7'b1110_001; //F1
			 5'd8: seg_out[6:0]=7'b0000_000; //80
			 5'd9: seg_out[6:0]=7'b0110_000; //B0
