...
module sdram_controller(
	...
	reg s2f_data_valid_q,s2f_data_valid_d, s2f_data_valid_d1;
	...
	always @(posedge clk,negedge rst_n) begin
		if(!rst_n) begin
			...
			s2f_data_valid_d1<=s2f_data_valid_d;
			s2f_data_valid_q<=s2f_data_valid_d1;
			rw_q<=rw_d;
			rw_en_q<=rw_en_d;
		end
	end
	...
	always @* begin
		...
		case(state_q)
			...
			start: begin //initiliaze after power-up
						...
						delay_ctr_d=16'd33; //wait for 200us //ORI/ /delay_ctr_d=16'd33_000
						s_addr_d=0;
						s_ba_d=0;
					 end
